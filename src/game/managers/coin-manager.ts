...
export class CoinManager {
    ...
    constructor(scene: Scene, icon: string = 'coin-sql') {
        this.scene = scene;
        this.icon = icon;
        this.init();
    }
    ...
    drawMany(repeat: number, stepX: number = 800): Phaser.Physics.Arcade.Group
    {
    ...
    private update(child: Phaser.GameObjects.GameObject) {
